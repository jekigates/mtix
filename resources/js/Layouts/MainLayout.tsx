        ...
        <div className="flex flex-col min-h-screen">
            ...
            <footer className="border-t text-muted-foreground p-4 bg-background">
                ...
                <p className="text-[10px]">
                    ...
                    copyrights and trademarks of 21Cineplex. No part of this
                    website may be reproduced in any form without our written
                    permission. Misuse of the entire content or any part,
                    multiply, translate, use, or utilize it without written
                    permission from 21Cineplex will be subject to criminal and /
                    or civil penalties.{" "}
